      ...
      <div className="back_support_add_note">
        <form id="modal_add_note_id" className="modal_add_note">
          ...
          <div className="modal_add_note_div">
            ...
            <textarea
              onChange={onchange}
              className="desc_add_note"
              id="description"
              name="description"
              placeholder="Write here..."
            ></textarea>
          </div>
          <button onClick={handleclick} className="add_but_add_note">
            Add Note
          </button>
        </form>
      </div>
        ...
        <div className="upper_div_add_note">
          <div className="left_add_note_div">
            ...
            <p className="but_footer">
              Start adding notes today to unlock a more organized and efficient
              way of capturing your thoughts!
            </p>
          </div>
          <div className="content_adding_note">
            ...
            <p className="point">
              The description is where you elaborate on the content of your
              note.
            </p>
            <p className="point">
              Tags are like labels that you can attach to your note to
              categorize and organize it alongside similar notes.
            </p>
          </div>
        </div>

        <button onClick={logout_func} className="logout_but">
          {/* <LogoutIcon className="logout_icon" /> */}
          Logout
        </button>
        {/* <button onClick={logout_func} className="logout_but_two">
          <LogoutIcon className="logout_icon_two" />
        </button> */}
        <Notes />
      </div>
    </>
