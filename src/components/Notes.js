    ...
    return (
        ...
        <div className="back_support_delete">
          <div id='delete_modal_id' className="delete_modal">
              <p className="delete_message_note">Are you sure you want to delete the note ?</p>
              <div className="delete_buttons_div">
                  <button onClick={close_delete} className="cancel_delete">Cancel</button>
                  <button id='abcd' className="delete_delete">Delete</button>
              </div>
          </div>
        </div>
        ...
        <div className="emodal_note_back_support">
          <form id="emodal_add_note_id" className="emodal_add_note">
            ...
            <div className="emodal_add_note_div">
                <input onChange={onchange_edit} className="etitle_add_note" type="text" id="etitle" name="etitle" value={enote.etitle} placeholder="Title"/>
                <textarea onChange={onchange_edit} className="edesc_add_note" id="edescription" name="edescription" value={enote.edescription} placeholder="Write here..."></textarea>
            </div>
            <button onClick={handleclick_edit} className="eadd_but_add_note">Update Note</button>
          </form>
        </div>
